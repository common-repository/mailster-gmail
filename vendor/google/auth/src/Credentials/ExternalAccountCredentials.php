...
use Mailster\Gmail\Google\Auth\CredentialSource\AwsNativeSource;
use Mailster\Gmail\Google\Auth\CredentialSource\FileSource;
use Mailster\Gmail\Google\Auth\CredentialSource\UrlSource;
use Mailster\Gmail\Google\Auth\ExternalAccountCredentialSourceInterface;
use Mailster\Gmail\Google\Auth\FetchAuthTokenInterface;
use Mailster\Gmail\Google\Auth\GetQuotaProjectInterface;
use Mailster\Gmail\Google\Auth\GetUniverseDomainInterface;
...
use Mailster\Gmail\Google\Auth\UpdateMetadataInterface;
use Mailster\Gmail\Google\Auth\UpdateMetadataTrait;
